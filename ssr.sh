...
r_file="/usr/local/lib/libsodium.so"
...
Install_Libsodium(){
	...
	ldconfig
	cd .. && rm -rf ${Libsodiumr_ver}-RELEASE.tar.gz && rm -rf ${Libsodiumr_ver}-RELEASE
...
echo -e "  ShadowsocksR 一键管理脚本 0+r製作 ${Red_font_prefix}[v${sh_ver}]${Font_color_suffix}
